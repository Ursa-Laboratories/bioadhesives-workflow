"""Data models for the automated bioadhesives workcell."""
...
@dataclass
class Experiment:
    """Ordered automated workcell experiment definition."""
...
def build_experiment(
    *,
    ...
    if not wells:
        raise ValueError("automated workflow needs at least one well")
    ...
    return Experiment(
        ...
        raw={
            ...
            "workflow": "automated_bioadhesives_workcell",
